<template>
    <div class="back-to-top" @click="backToTop" v-show="showReturnToTop" @mouseenter="show" @mouseleave="hide">
        ...
        <span class="tips" :class="[bttOption.iPos]" :style="{color:bttOption.textColor}" v-show="showTooltips"></span>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            ...
            currentPageYOffset () {
                ...
                scrollTop > this.pageY ? this.showReturnToTop = true : this.showReturnToTop = false;
            },
            backToTop () {
...
<style scoped lang="scss">
    .back-to-top {
        ...
        i {
            ...
            text-align: center;
            padding: 5px;
            background-image: url('../../../static/img/rocket.jpg') ;
