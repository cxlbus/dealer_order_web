    ...
    <div class="table">
        ...
        <div class="container">
            <div class="handle-box">
                ...
                <el-select v-model="select_cate" multiple collapse-tags :placeholder="$t('label_orderStatus')">
                    <el-option
                        v-for="a in status"
                        :key="a.labelcode"
                        :label="a.value"
                ...
                <el-select v-model="select_cate_pay" :placeholder="$t('label_payment_status')"
                           class="handle-select mr10">
                    <el-option
                        v-for='a in paystatus'
                        :key="a.labelcode"
                        :label="a.value"
                        :value="a.labelcode"
                    >
        ...
        methods: {
            ...
            getData() {
                ...
                let data = {
                    ...
                    "order_number": "",
                    "order_status": this.select_cate.length > 0 ? this.select_cate : this.all_order,
