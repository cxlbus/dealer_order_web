    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                url: '/login_after/staff/get_all',
                url2: '/login_after/staff/get_role',
                url3: '/login_after/staff/modify',
                url4: '/login_after/staff/modify_role',
                url5: '/login_after/staff/get_all_role',
                url6: '/login_after/staff/add',
        ...
        methods: {
                    ...
                    if (valid) {
                        const data={
                            data:{
                                ...
                                password: this.$crypto.MD5(16,this.ruleForm2.password),
            ...
            modifyRow() {
                ...
                this.$axios.post(this.url4, {data: dataJson}).then((res) => {
                    if (res.data.code == 200) {
                        this.$refs.multipleTable.clearSelection();
